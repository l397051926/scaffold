package com.lmx.scaffold.dao.datasource;
...
import com.lmx.scaffold.commons.utils.PropertyUtils;
...
public class SpringConnectionFactory {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.mlamp.dashboard.dao.entity");
        ResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
        sqlSessionFactoryBean.setMapperLocations(resolver.getResources("com/mlamp/dashboard/dao/mapper/*Mapper.xml"));
        sqlSessionFactoryBean.setTypeEnumsPackage("com.mlamp.dashboard.*.enums");
